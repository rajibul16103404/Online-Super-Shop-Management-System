        ...
        <br><br><br><br><br> 
        <div class="run">
        <marquee>Log in as   [<i class="fa fa-user"></i>User]   first in case of order a product.</marquee>
        </div>
        ...
        <?php
                ...
                if(mysqli_num_rows($qry)>0)
            {
                ...
                {
        ?>
        <a href="details.php?id=<?php echo $row['id']; ?>"><div class="product">
            <div class="pimg">
